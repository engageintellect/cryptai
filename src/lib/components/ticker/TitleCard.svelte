<script lang="ts">
  ...
  export let explorer: string
  export let rank: string
  export let coinHomepage: string
  export let reposUrl: string
  export let subreddit: string
  export let whitepaper: string
  export let coinImage: string
